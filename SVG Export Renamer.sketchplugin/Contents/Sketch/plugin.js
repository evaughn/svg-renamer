...
/*!***************************!*\
  !*** ./src/case-utils.js ***!
  \***************************/
/*! exports provided: caseTypeMapping, selectedCaseMapping */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "caseTypeMapping", function() { return caseTypeMapping; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectedCaseMapping", function() { return selectedCaseMapping; });
var caseTypeMapping = {
  dash: 0,
  snake: 1,
  title: 2
};
var selectedCaseMapping = {
  dash: "-",
  snake: "_",
  title: "-*-"
};
...
/*!***********************!*\
  !*** ./src/dialog.js ***!
  \***********************/
/*! exports provided: showDialog, getDefaults, savePreferences, resetPreferences */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _case_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./case-utils */ "./src/case-utils.js");


var suiteName = "com.sketchapp.plugins.svg-export-renamer.defaults";
var userDefaults;
var overrideArtboard;
...
function showDialog(context) {
  ...
  settingsDialog.setIcon(NSImage.alloc().initByReferencingFile(context.plugin.urlForResourceNamed("icon.png").path()));
  ...
  var caseLabel = NSTextField.alloc().initWithFrame(NSMakeRect(0, viewHeight - 25, viewWidth - 100, 20));
  ...
  var caseType = NSPopUpButton.alloc().initWithFrame(NSMakeRect(0, viewHeight - 47, viewWidth, 22));
  ...
  caseType.setCOSJSTargetFunction(function (sender) {
  ...
  var checkbox = NSButton.alloc().initWithFrame(NSMakeRect(0, viewHeight - 70, viewWidth, 20));
  overrideArtboard = getDefaults().overrideArtboard; // Setting the options for the checkbox
  ...
  var prefixSuffixDropdown = NSPopUpButton.alloc().initWithFrame(NSMakeRect(0, viewHeight - 110, viewWidth / 2, 22)); // Filling the PopUpButton with options
  ...
  prefixSuffixDropdown.setCOSJSTargetFunction(function (sender) {
...
var getSelectedCaseIndex = function getSelectedCaseIndex() {
  var _getDefaults = getDefaults(),
      selectedCaseType = _getDefaults.selectedCaseType;

  return _case_utils__WEBPACK_IMPORTED_MODULE_1__["caseTypeMapping"][selectedCaseType];
};
...
function createPrefixView(parentViewWidth, parentViewHeight) {
  ...
  var _getDefaults2 = getDefaults(),
      userUsePrefix = _getDefaults2.usePrefix,
      userUseDefault = _getDefaults2.useDefaultPrefix;

  var baseY = parentViewHeight - 210;
  var view = NSView.alloc().initWithFrame(NSMakeRect(0, parentViewHeight - 225, parentViewWidth, 400));
...
function createSuffixView(parentViewWidth, parentViewHeight) {
  ...
  var _getDefaults3 = getDefaults(),
      userUseSuffix = _getDefaults3.useCustomSuffix;
...
function getPrefixSettings() {
  return {
    noPrefixSetting: userDefaults.objectForKey("usePrefix") != nil && userDefaults.objectForKey("useDefaultPrefix") != nil ? userDefaults.objectForKey("usePrefix") != 1 && userDefaults.objectForKey("useDefaultPrefix") != 1 ? NSOnState : NSOffState : NSOffState,
    defaultPrefixSetting: userDefaults.objectForKey("usePrefix") != nil && userDefaults.objectForKey("useDefaultPrefix") != nil ? userDefaults.objectForKey("usePrefix") == 1 && userDefaults.objectForKey("useDefaultPrefix") == 1 ? NSOnState : NSOffState : NSOnState,
    customPrefixSetting: userDefaults.objectForKey("usePrefix") != nil && userDefaults.objectForKey("useDefaultPrefix") != nil ? userDefaults.objectForKey("usePrefix") == 1 && userDefaults.objectForKey("useDefaultPrefix") != 1 ? NSOnState : NSOffState : NSOffState
  };
}

function getSuffixSettings() {
  return {
    noSuffixSetting: userDefaults.objectForKey("useCustomSuffix") != nil ? userDefaults.objectForKey("useCustomSuffix") == 1 ? NSOffState : NSOnState : NSOnState,
    customSuffixSetting: userDefaults.objectForKey("useCustomSuffix") != nil ? userDefaults.objectForKey("useCustomSuffix") == 1 ? NSOnState : NSOffState : NSOffState
  };
}
...
function savePreferences() {
  ...
  userDefaults.setObject_forKey(customSuffixTextField.stringValue().replace(/\W/, ""), "customSuffix");
...
/* harmony import */ var _case_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./case-utils */ "./src/case-utils.js");
...
function configureName(name) {
  var predefinedPrefixSuffix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

  var _getDefaults = Object(_dialog__WEBPACK_IMPORTED_MODULE_2__["getDefaults"])(),
      overrideArtboard = _getDefaults.overrideArtboard,
      selectedCaseType = _getDefaults.selectedCaseType,
      usePrefix = _getDefaults.usePrefix,
      useDefaultPrefix = _getDefaults.useDefaultPrefix,
      customPrefix = _getDefaults.customPrefix,
      useCustomSuffix = _getDefaults.useCustomSuffix,
      customSuffix = _getDefaults.customSuffix;

  var caseConnector = _case_utils__WEBPACK_IMPORTED_MODULE_3__["selectedCaseMapping"][selectedCaseType];
  var pluginUseDefaultPrefix = usePrefix && useDefaultPrefix;
  var pluginUseCustomPrefix = usePrefix && !useDefaultPrefix;
  ...
  if (usePrefix) {
    if (pluginUseDefaultPrefix) {
      name = "".concat(defaultPrefix).concat(caseConnector).concat(name);
    }

    if (pluginUseCustomPrefix) {
      name = "".concat(customPrefix).concat(caseConnector).concat(name);
    }
  }

  if (useCustomSuffix) {
    name += "".concat(caseConnector).concat(customSuffix);
  }

  if (selectedCaseType == "title") {
    var nameArray = name.split(caseConnector);
    name = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["map"])(nameArray, function (split, index) {
      if (index === 0) {
        return split;
      }
...
function getOverrideName(fileName, artboardName) {
  var _getDefaults2 = Object(_dialog__WEBPACK_IMPORTED_MODULE_2__["getDefaults"])(),
      overrideArtboard = _getDefaults2.overrideArtboard;

  var overrideName = overrideArtboard ? artboardName : fileName;
...
function renameExport(context) {
  ...
  if (filesToRename.length > 0) {
    var oldFiles = {};
    var oldFilePaths = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["reduce"])(filesToRename, function (dictionary, fileDict) {
      var fileName = fileDict.request.name();
      var artboardName = fileDict.request.rootLayer().name();
      var hasPredefinedPrefixSuffix = fileName.toLowerCase() === artboardName.toLowerCase() ? false : true;
      var name = getOverrideName(fileName, artboardName);
      var exportName = "";
      ...
      if (nameArray.length === 1 || typeName === "default" || !!parseInt(typeName)) {
        ...
        exportName = configureName("".concat(categoryName, " ").concat(typeName), hasPredefinedPrefixSuffix);
      }

      var newOutputPath = fileDict.path.replace("".concat(fileName, ".svg"), "".concat(exportName, ".svg")); // creates new NSMutableDictionary to reassign the export path

      var newExportDictionary = NSMutableDictionary.alloc().init();
      var oldFileIndex = exports.indexOfObjectIdenticalTo(fileDict);
      ...
      if (fileManager.fileExistsAtPath(fileDict.path)) {
        ...
        if (name === exportName) {
          ...
          try {
            ...
            return Promise.reject("Error in deleting source icon: ".concat(e));
          }
        } else {
          var _svgFile = NSString.stringWithContentsOfFile_encoding_error(fileDict.path, NSUTF8StringEncoding, "Error in reading icon");

          _svgFile.writeToFile_atomically(newOutputPath, true);
        }
      }
